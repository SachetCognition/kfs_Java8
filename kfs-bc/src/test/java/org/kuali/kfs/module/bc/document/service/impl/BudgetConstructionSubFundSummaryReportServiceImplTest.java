...
public class BudgetConstructionSubFundSummaryReportServiceImplTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private BudgetConstructionSubFundSummaryReportServiceImpl service;
