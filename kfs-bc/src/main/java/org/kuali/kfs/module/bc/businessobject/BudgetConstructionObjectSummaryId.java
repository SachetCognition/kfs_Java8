...
public class BudgetConstructionObjectSummaryId implements Serializable {
    ...
    public BudgetConstructionObjectSummaryId() {}
    ...
    public boolean equals(Object o) {
        ...
        BudgetConstructionObjectSummaryId that = (BudgetConstructionObjectSummaryId) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(principalId, organizationChartOfAccountsCode, organizationCode, subFundGroupCode, chartOfAccountsCode, incomeExpenseCode, financialConsolidationSortCode, financialLevelSortCode, financialObjectCode);
    }
}
