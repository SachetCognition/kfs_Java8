...
public class BudgetConstructionLevelSummaryId implements Serializable {
    ...
    public BudgetConstructionLevelSummaryId() {}
    ...
    public boolean equals(Object o) {
        ...
        BudgetConstructionLevelSummaryId that = (BudgetConstructionLevelSummaryId) o;
        return Objects.equals(principalId, that.principalId) && Objects.equals(organizationChartOfAccountsCode, that.organizationChartOfAccountsCode) && Objects.equals(organizationCode, that.organizationCode) && Objects.equals(subFundGroupCode, that.subFundGroupCode) && Objects.equals(chartOfAccountsCode, that.chartOfAccountsCode) && Objects.equals(incomeExpenseCode, that.incomeExpenseCode) && Objects.equals(financialConsolidationSortCode, that.financialConsolidationSortCode) && Objects.equals(financialLevelSortCode, that.financialLevelSortCode);
    }

    @Override
    public int hashCode() {
        return Objects.hash(principalId, organizationChartOfAccountsCode, organizationCode, subFundGroupCode, chartOfAccountsCode, incomeExpenseCode, financialConsolidationSortCode, financialLevelSortCode);
    }
}
