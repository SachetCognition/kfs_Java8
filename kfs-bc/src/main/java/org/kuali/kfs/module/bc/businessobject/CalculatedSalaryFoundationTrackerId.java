...
public class CalculatedSalaryFoundationTrackerId implements Serializable {
    ...
    public CalculatedSalaryFoundationTrackerId() {}
    ...
    public java.sql.Timestamp getCsfCreateTimestamp() { return csfCreateTimestamp; }
    public void setCsfCreateTimestamp(java.sql.Timestamp csfCreateTimestamp) { this.csfCreateTimestamp = csfCreateTimestamp; }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        CalculatedSalaryFoundationTrackerId that = (CalculatedSalaryFoundationTrackerId) o;
        return Objects.equals(universityFiscalYear, that.universityFiscalYear) && Objects.equals(chartOfAccountsCode, that.chartOfAccountsCode) && Objects.equals(accountNumber, that.accountNumber) && Objects.equals(subAccountNumber, that.subAccountNumber) && Objects.equals(financialObjectCode, that.financialObjectCode) && Objects.equals(financialSubObjectCode, that.financialSubObjectCode) && Objects.equals(positionNumber, that.positionNumber) && Objects.equals(emplid, that.emplid) && Objects.equals(csfCreateTimestamp, that.csfCreateTimestamp);
    }
