...
public class OrganizationOptionsId implements Serializable {
    private static final long serialVersionUID = 1L;

    private String chartOfAccountsCode;
    private String organizationCode;

    public OrganizationOptionsId() {}

    public OrganizationOptionsId(String chartOfAccountsCode, String organizationCode) {
    ...
    public boolean equals(Object o) {
        ...
        OrganizationOptionsId that = (OrganizationOptionsId) o;
