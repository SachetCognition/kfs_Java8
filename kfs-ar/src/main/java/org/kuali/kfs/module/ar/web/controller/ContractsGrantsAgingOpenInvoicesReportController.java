...
public class ContractsGrantsAgingOpenInvoicesReportController {
    ...
    public String viewResults(@ModelAttribute("ContractsGrantsAgingOpenInvoicesReportForm") ContractsGrantsAgingOpenInvoicesReportForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }
}
