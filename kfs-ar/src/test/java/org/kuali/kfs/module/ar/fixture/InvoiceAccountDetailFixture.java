...
public enum InvoiceAccountDetailFixture {
    ...
    INV_ACCT_DTL1("5030", Long.valueOf(80072), "IN", "9000000", "", new KualiDecimal(300), KualiDecimal.ZERO, KualiDecimal.ZERO, new KualiDecimal(300), KualiDecimal.ZERO),
    INV_ACCT_DTL2("5030", Long.valueOf(80072), "IN", "9000001", "", new KualiDecimal(120), KualiDecimal.ZERO, KualiDecimal.ZERO, new KualiDecimal(120), KualiDecimal.ZERO),
    INV_ACCT_DTL3("5030", Long.valueOf(80072), "BL", "2336320", "0142900", new KualiDecimal(120), new KualiDecimal(1), KualiDecimal.ZERO, new KualiDecimal(120), KualiDecimal.ZERO),
    INV_ACCT_DTL4("5030", Long.valueOf(80072), "IN", "1292016", "2336320", new KualiDecimal(120), new KualiDecimal(1), KualiDecimal.ZERO, new KualiDecimal(120), KualiDecimal.ZERO),
    INV_ACCT_DTL5("5030", Long.valueOf(80072), "IN", "9000000", "", new KualiDecimal(300), KualiDecimal.ZERO, new KualiDecimal(300), new KualiDecimal(300), KualiDecimal.ZERO);
