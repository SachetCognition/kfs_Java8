...
public class ExtractChecksStepTest extends KfsUnitTestBase {

    @Mock
    private ExtractPaymentService extractPaymentService;

    @InjectMocks
    private ExtractChecksStep step;
    ...
    public void testExecuteSuccess() throws Exception {
        ...
        assertTrue(result);
        verify(extractPaymentService).extractChecks();
    }

    @Test
    public void testExecuteServiceInteraction() throws Exception {
        step.execute("testJob", new Date());
        verify(extractPaymentService, atLeastOnce()).extractChecks();
    }
