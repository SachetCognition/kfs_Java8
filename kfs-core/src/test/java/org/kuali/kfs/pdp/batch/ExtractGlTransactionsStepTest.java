...
public class ExtractGlTransactionsStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private ExtractGlTransactionsStep step;

    @BeforeEach
    public void setUp() {
        step.setExtractGlTransactionService(extractGlTransactionService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(extractGlTransactionService).extractGlTransactions();
    }
