...
public class InactivatePayeeAchAccountsStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private InactivatePayeeAchAccountsStep step;

    @BeforeEach
    public void setUp() {
        step.setInactivatePayeeAchAccountsService(inactivatePayeeAchAccountsService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(inactivatePayeeAchAccountsService).inactivatePayeeAchAccounts();
    }
