...
public class AutoDisapproveDocumentsStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private AutoDisapproveDocumentsStep step;

    @BeforeEach
    public void setUp() {
        step.setAutoDisapproveDocumentsService(autoDisapproveDocumentsService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(autoDisapproveDocumentsService).autoDisapproveDocumentsInEnrouteStatus();
    }
