...
public class AddPriorYearAccountsStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private AddPriorYearAccountsStep step;
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(priorYearAccountService).addPriorYearAccountsFromParameter();
    }
