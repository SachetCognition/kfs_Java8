...
class OrganizationReversionDetailTrickleDownInactivationServiceImplTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private OrganizationReversionDetailTrickleDownInactivationServiceImpl service;
