...
public class SubObjectCodeServiceTest extends KualiTestBase {
    ...
    public void testEmptyParam() {
        SubObjectCode resultSubObjectCode = SpringContext.getBean(SubObjectCodeService.class).getByPrimaryId(Integer.valueOf(0), TestConstants.Data4.CHART_CODE, TestConstants.Data4.ACCOUNT, TestConstants.Data4.OBJECT_CODE, TestConstants.Data4.SUBOBJECT_CODE);
