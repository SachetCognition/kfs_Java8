...
public class PurgeSufficientFundBalancesStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private PurgeSufficientFundBalancesStep step;

    @BeforeEach
    public void setUp() {
        step.setParameterService(parameterService);
        step.setSufficientFundsService(sufficientFundsService);
