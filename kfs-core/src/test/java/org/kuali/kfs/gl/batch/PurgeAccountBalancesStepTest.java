...
public class PurgeAccountBalancesStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private PurgeAccountBalancesStep step;

    @BeforeEach
    public void setUp() {
        step.setParameterService(parameterService);
        step.setAccountBalanceService(accountBalanceService);
