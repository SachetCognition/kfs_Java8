...
public class OrganizationReversionCurrentYearAccountStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private OrganizationReversionCurrentYearAccountStep step;

    @BeforeEach
    public void setUp() {
        step.setOrganizationReversionProcessService(organizationReversionProcessService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(organizationReversionProcessService).getJobParameters();
    }
