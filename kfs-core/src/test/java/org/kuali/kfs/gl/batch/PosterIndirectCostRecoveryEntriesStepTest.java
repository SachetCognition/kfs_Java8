...
public class PosterIndirectCostRecoveryEntriesStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private PosterIndirectCostRecoveryEntriesStep step;
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(posterService).postIcrEntries();
    }
