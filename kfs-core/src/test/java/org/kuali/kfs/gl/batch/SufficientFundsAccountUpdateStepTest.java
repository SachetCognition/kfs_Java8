...
public class SufficientFundsAccountUpdateStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private SufficientFundsAccountUpdateStep step;

    @BeforeEach
    public void setUp() {
        step.setSufficientFundsAccountUpdateService(sufficientFundsAccountUpdateService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(sufficientFundsAccountUpdateService).rebuildSufficientFunds();
    }
