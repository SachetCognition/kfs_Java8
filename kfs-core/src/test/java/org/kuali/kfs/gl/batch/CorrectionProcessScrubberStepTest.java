...
public class CorrectionProcessScrubberStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private CorrectionProcessScrubberStep step;

    @BeforeEach
    public void setUp() {
        step.setCorrectionDocumentService(correctionDocumentService);
