 ...
 */
public class IndirectCostRecoveryTypeDaoJpa extends PlatformAwareDaoBaseOjb implements IndirectCostRecoveryTypeDao {
    private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(IndirectCostRecoveryTypeDaoJpa.class);
