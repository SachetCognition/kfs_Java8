    ...
    protected boolean doCustomPreRules(MaintenanceDocument maintenanceDocument) {
        ...
        for (ObjectCodeGlobalDetail detail : details) {
            if (detail.getUniversityFiscalYear() == null) {
                ...
                detail.setUniversityFiscalYear(Integer.valueOf(SpringContext.getBean(MaintenanceDocumentDictionaryService.class).getCollectionFieldDefaultValue(maintenanceDocument.getDocumentHeader().getWorkflowDocument().getDocumentTypeName(), "objectCodeGlobalDetails", "universityFiscalYear")));
            }
        }
