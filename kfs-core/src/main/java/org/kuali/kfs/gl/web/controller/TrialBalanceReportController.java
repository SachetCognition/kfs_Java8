...
public class TrialBalanceReportController {
    ...
    public String viewResults(@ModelAttribute("TrialBalanceReportForm") TrialBalanceReportForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }

    @RequestMapping(params = "methodToCall=print")
    public void print(@ModelAttribute("TrialBalanceReportForm") TrialBalanceReportForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
