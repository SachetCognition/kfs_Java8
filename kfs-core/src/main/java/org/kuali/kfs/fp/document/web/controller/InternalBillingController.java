...
public class InternalBillingController {
    ...
    @RequestMapping(params = "methodToCall=deleteItem")
    public String deleteItem(@ModelAttribute("InternalBillingForm") InternalBillingForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }
}
