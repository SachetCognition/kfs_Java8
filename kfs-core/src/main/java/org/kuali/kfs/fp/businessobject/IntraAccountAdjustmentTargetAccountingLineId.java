...
public class IntraAccountAdjustmentTargetAccountingLineId implements Serializable {
    ...
    public IntraAccountAdjustmentTargetAccountingLineId() {}

    public IntraAccountAdjustmentTargetAccountingLineId(String documentNumber, Integer sequenceNumber, String financialDocumentLineTypeCode) {
    ...
    public boolean equals(Object o) {
        ...
        IntraAccountAdjustmentTargetAccountingLineId that = (IntraAccountAdjustmentTargetAccountingLineId) o;
