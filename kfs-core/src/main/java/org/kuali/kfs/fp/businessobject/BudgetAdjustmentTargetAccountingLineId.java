...
public class BudgetAdjustmentTargetAccountingLineId implements Serializable {
    ...
    public BudgetAdjustmentTargetAccountingLineId() {}

    public BudgetAdjustmentTargetAccountingLineId(String documentNumber, Integer sequenceNumber, String financialDocumentLineTypeCode) {
    ...
    public boolean equals(Object o) {
        ...
        BudgetAdjustmentTargetAccountingLineId that = (BudgetAdjustmentTargetAccountingLineId) o;
