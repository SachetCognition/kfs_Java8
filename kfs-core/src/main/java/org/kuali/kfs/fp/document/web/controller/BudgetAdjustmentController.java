...
public class BudgetAdjustmentController {
    ...
    public String copy(@ModelAttribute("BudgetAdjustmentForm") BudgetAdjustmentForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }
}
