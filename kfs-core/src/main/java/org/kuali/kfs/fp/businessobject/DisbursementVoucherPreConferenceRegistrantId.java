...
public class DisbursementVoucherPreConferenceRegistrantId implements Serializable {
    ...
    public DisbursementVoucherPreConferenceRegistrantId() {}

    public DisbursementVoucherPreConferenceRegistrantId(String documentNumber, Integer financialDocumentLineNumber) {
    ...
    public boolean equals(Object o) {
        ...
        DisbursementVoucherPreConferenceRegistrantId that = (DisbursementVoucherPreConferenceRegistrantId) o;
