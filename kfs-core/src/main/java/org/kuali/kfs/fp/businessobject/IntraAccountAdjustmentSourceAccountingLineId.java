...
public class IntraAccountAdjustmentSourceAccountingLineId implements Serializable {
    ...
    public IntraAccountAdjustmentSourceAccountingLineId() {}

    public IntraAccountAdjustmentSourceAccountingLineId(String documentNumber, Integer sequenceNumber, String financialDocumentLineTypeCode) {
    ...
    public boolean equals(Object o) {
        ...
        IntraAccountAdjustmentSourceAccountingLineId that = (IntraAccountAdjustmentSourceAccountingLineId) o;
