...
public class VoucherController {
    ...
    public String insertSourceLine(@ModelAttribute("VoucherForm") VoucherForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }

    @RequestMapping(params = "methodToCall=deleteSourceLine")
    public String deleteSourceLine(@ModelAttribute("VoucherForm") VoucherForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }

    @RequestMapping(params = "methodToCall=copy")
    public String copy(@ModelAttribute("VoucherForm") VoucherForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }
}
