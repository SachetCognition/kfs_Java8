...
public class ProcurementCardVendorId implements Serializable {
    ...
    public ProcurementCardVendorId() {}

    public ProcurementCardVendorId(String documentNumber, Integer financialDocumentTransactionLineNumber) {
    ...
    public boolean equals(Object o) {
        ...
        ProcurementCardVendorId that = (ProcurementCardVendorId) o;
