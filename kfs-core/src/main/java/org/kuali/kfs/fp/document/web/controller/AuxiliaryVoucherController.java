...
public class AuxiliaryVoucherController {
    ...
    @RequestMapping(params = "methodToCall=changeVoucherType")
    public String changeVoucherType(@ModelAttribute("AuxiliaryVoucherForm") AuxiliaryVoucherForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }

    @RequestMapping(params = "methodToCall=docHandler")
    public String docHandler(@ModelAttribute("AuxiliaryVoucherForm") AuxiliaryVoucherForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return "basic";
    }
}
