...
public class BudgetAdjustmentSourceAccountingLineId implements Serializable {
    ...
    public BudgetAdjustmentSourceAccountingLineId() {}

    public BudgetAdjustmentSourceAccountingLineId(String documentNumber, Integer sequenceNumber, String financialDocumentLineTypeCode) {
    ...
    public boolean equals(Object o) {
        ...
        BudgetAdjustmentSourceAccountingLineId that = (BudgetAdjustmentSourceAccountingLineId) o;
