...
public class AutoClosePurchaseOrderViewId implements Serializable {
    ...
    public AutoClosePurchaseOrderViewId() {
    }

    public AutoClosePurchaseOrderViewId(Integer accountsPayablePurchasingDocumentLinkIdentifier, Integer purapDocumentIdentifier, String documentNumber) {
    ...
    public boolean equals(Object o) {
        ...
        AutoClosePurchaseOrderViewId that = (AutoClosePurchaseOrderViewId) o;
