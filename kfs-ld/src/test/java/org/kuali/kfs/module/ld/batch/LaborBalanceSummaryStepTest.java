...
public class LaborBalanceSummaryStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private LaborBalanceSummaryStep step;

    @BeforeEach
    public void setUp() {
        step.setLaborBalanceSummaryReportService(laborBalanceSummaryReportService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(laborBalanceSummaryReportService).generateBalanceSummaryReports();
    }
