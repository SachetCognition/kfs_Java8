...
public class ClearLaborPendingStepTest extends KfsUnitTestBase {

    @Mock
    private LaborNightlyOutService laborNightlyOutService;

    @InjectMocks
    private ClearLaborPendingStep step;
    ...
    public void testExecuteSuccess() throws Exception {
        ...
        assertTrue(result);
        verify(laborNightlyOutService).deleteCopiedPendingLedgerEntries();
    }

    @Test
    public void testExecuteServiceInteraction() throws Exception {
        step.execute("testJob", new Date());
        verify(laborNightlyOutService, atLeastOnce()).deleteCopiedPendingLedgerEntries();
    }
