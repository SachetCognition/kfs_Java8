...
public class ClearLaborGLEntryStepTest extends KfsUnitTestBase {

    @Mock
    private LaborNightlyOutService laborNightlyOutService;

    @InjectMocks
    private ClearLaborGLEntryStep step;
    ...
    public void testExecuteSuccess() throws Exception {
        ...
        assertTrue(result);
        verify(laborNightlyOutService).deleteCopiedLaborGenerealLedgerEntries();
    }

    @Test
    public void testExecuteServiceInteraction() throws Exception {
        step.execute("testJob", new Date());
        verify(laborNightlyOutService, atLeastOnce()).deleteCopiedLaborGenerealLedgerEntries();
    }
