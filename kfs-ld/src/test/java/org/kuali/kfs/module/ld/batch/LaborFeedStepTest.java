...
public class LaborFeedStepTest extends KfsUnitTestBase {

    @Mock
    private LaborNightlyOutService laborNightlyOutService;

    @InjectMocks
    private LaborFeedStep step;
    ...
    public void testExecuteSuccess() throws Exception {
        ...
        assertTrue(result);
        verify(laborNightlyOutService).copyLaborGenerealLedgerEntries();
    }

    @Test
    public void testExecuteServiceInteraction() throws Exception {
        step.execute("testJob", new Date());
        verify(laborNightlyOutService, atLeastOnce()).copyLaborGenerealLedgerEntries();
    }
