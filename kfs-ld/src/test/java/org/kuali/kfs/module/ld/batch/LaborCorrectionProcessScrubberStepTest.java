...
public class LaborCorrectionProcessScrubberStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private LaborCorrectionProcessScrubberStep step;

    @BeforeEach
    public void setUp() {
        step.setLaborCorrectionDocumentService(laborCorrectionDocumentService);
        step.setLaborScrubberService(laborScrubberService);
