...
public class LaborYearEndBalanceForwardStepTest extends KfsUnitTestBase {
    ...
    @InjectMocks
    private LaborYearEndBalanceForwardStep step;

    @BeforeEach
    public void setUp() {
        step.setLaborYearEndBalanceForwardService(laborYearEndBalanceForwardService);
    ...
    public void testCustomBatchExecutorCallsService() throws Exception {
        ...
        executor.execute();
        verify(laborYearEndBalanceForwardService).forwardBalance();
    }
