...
@Entity
@Table(name = "LD_PND_LDGR_ENTR_T")
@IdClass(LaborLedgerPendingEntryId.class)
/**
...
public class LaborLedgerPendingEntry extends GeneralLedgerPendingEntry implements LaborTransaction, LaborLedgerPendingEntryForSearching {
    ...
    @JoinColumns({
        ...
        @JoinColumn(name = "UNIV_FISCAL_PRD_CD", referencedColumnName = "UNIV_FISCAL_PRD_CD", insertable = false, updatable = false)
