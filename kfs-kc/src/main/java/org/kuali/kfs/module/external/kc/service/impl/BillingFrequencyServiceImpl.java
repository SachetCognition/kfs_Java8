...
public class BillingFrequencyServiceImpl implements ExternalizableBusinessObjectService, BillingFrequencyService {
    ...
    protected BillingFrequencyMappingDao billingFrequencyMappingDao;
    ...
    protected BillingFrequencyMapping getFrequencyMapping(String kcFrequencyCode) {
        Collection<BillingFrequencyMapping> mappings = billingFrequencyMappingDao.findByKcFrequencyCode(kcFrequencyCode);
    ...
    protected BillingFrequencyMappingDao getBillingFrequencyMappingDao() {
        return billingFrequencyMappingDao;
    }

    public void setBillingFrequencyMappingDao(BillingFrequencyMappingDao billingFrequencyMappingDao) {
        this.billingFrequencyMappingDao = billingFrequencyMappingDao;
    }
