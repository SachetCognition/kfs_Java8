...
public class PersistenceStructureServiceImpl implements org.kuali.rice.krad.service.PersistenceStructureService {
    ...
    public Map getReferenceConversionMap(Class clazz) { return referenceConversionMap; }
    ...
    public java.util.List<String> getPrimaryKeys(Class clazz) { return new java.util.ArrayList<String>(); }
    public Class getBusinessObjectAttributeClass(Class clazz, String attributeName) { return String.class; }
    public boolean hasPrimaryKeyFieldValues(Object obj) { return true; }
    public String getForeignKeyFieldName(Class clazz, String attributeName, String pkFieldName) { return null; }
}
