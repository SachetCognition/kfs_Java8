...
public class AssetPaymentDaoJpa implements AssetPaymentDao {
    ...
    public Integer getMaxSquenceNumber(Long capitalAssetNumber) {
        TypedQuery<Integer> query = entityManager.createQuery(
                "SELECT MAX(ap.paymentSequenceNumber) FROM AssetPayment ap WHERE ap.capitalAssetNumber = :assetNumber",
                Integer.class);
        query.setParameter("assetNumber", capitalAssetNumber);
