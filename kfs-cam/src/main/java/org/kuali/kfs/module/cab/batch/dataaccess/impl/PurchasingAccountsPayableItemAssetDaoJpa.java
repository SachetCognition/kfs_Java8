...
public class PurchasingAccountsPayableItemAssetDaoJpa implements PurchasingAccountsPayableItemAssetDao {
    ...
    public Integer findMaxCabLineNumber(String documentNumber, Integer accountsPayableLineItemIdentifier) {
        ...
        query.setParameter("lineItemId", accountsPayableLineItemIdentifier);
